...
<!-- num2 -->
	<div class="web_conTop">
		...
		<div class="contop_Info fixed">
			...
			<?php echo catpos($catid);?>&nbsp;<?php echo $CATEGORYS[$catid]['catname'];?>
		</div>
	</div>
<!-- num3 -->
        	...
        	<div class="webbom_text">
        		...
        		<?php if($j==1) { ?>
	               ...
	               <!--  <div class="bomtext_tit">
	                	<img src="<?php echo $c['thumb'];?>" height="175" width="671" alt="">
	                </div> -->
               		 <div class="bomtext_tit">
                            <img src="<?php echo IMG_PATH;?>drlimg/kjdtPic1.jpg" height="175" width="671" alt="">
                        </div> 
                        
	                <div class="jtywList">
                            <ul>
                             <?php $n=1;if(is_array($data)) foreach($data AS $c) { ?>
                                <li><a href="<?php echo $c['url'];?>"><h3><?php echo $c['title'];?></h3><p><span><?php echo date("Y-m-d",$c[inputtime]);?></span></p></a></li>
                                 <?php $n++;}unset($n); ?>
                            </ul>
                        </div>
